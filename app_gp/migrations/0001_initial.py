# Generated by Django 2.2.1 on 2019-08-03 02:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('slug', models.SlugField(blank=True, null=True, verbose_name='Indentificador')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_gp.ChoicesCity', verbose_name='Cidade')),
        ...
        migrations.AddField(
            model_name='client',
            name='ethnicity',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_gp.ChoicesEthnicity', verbose_name='Etnia'),
        ),
        migrations.AddField(
            model_name='client',
            name='eye',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_gp.ChoicesEyeColor', verbose_name='Olhos'),
        ),
        migrations.AddField(
            model_name='client',
            name='genre',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_gp.ChoicesGenre', verbose_name='Gênero'),
        ),
        migrations.AddField(
            model_name='client',
