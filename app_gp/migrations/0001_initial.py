# Generated by Django 2.2.4 on 2019-08-28 21:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_email', models.EmailField(max_length=254, null=True, unique=True, verbose_name='E-mail')),
                ...
                ('image_profile', models.ImageField(blank=True, null=True, upload_to=app_gp.models.profile_upload_path, verbose_name='Imagem de Perfil')),
                ('image_thumb', models.ImageField(blank=True, null=True, upload_to=app_gp.models.thumb_upload_path, verbose_name='Thumb')),
                ...
                ('hip', models.FloatField(blank=True, null=True, verbose_name='Quadril(cm)')),
                ('butt', models.FloatField(blank=True, null=True, verbose_name='Bunda(cm)')),
                ('foot', models.FloatField(blank=True, null=True, verbose_name='Pés')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_gp.Client')),
        ...
        migrations.CreateModel(
            name='InterClientLanguages',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_gp.Client')),
                ('language', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app_gp.ChoicesLanguage')),
            ],
            options={
                'verbose_name': 'Idioma',
                'verbose_name_plural': 'Idiomas',
        ...
        migrations.AddField(
            model_name='client',
            name='languages',
            field=models.ManyToManyField(through='app_gp.InterClientLanguages', to='app_gp.ChoicesLanguage', verbose_name='Idiomas'),
        ),
        migrations.AddField(
            model_name='client',
        ...
        migrations.AddField(
            ...
            name='state',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app_gp.ChoicesStates', verbose_name='Estado'),
        ),
        migrations.CreateModel(
            name='ClientVideo',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('video', models.FileField(upload_to=app_gp.models.videos_upload_path, verbose_name='Videos')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('photo', models.ImageField(upload_to=app_gp.models.photos_upload_path, verbose_name='Fotos')),
