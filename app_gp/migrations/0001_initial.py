    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_services', models.ManyToManyField(db_table='inter_client_customer_services', to='app_gp.ChoicesCustomerService', verbose_name='Atendimentos')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='app_gp.Client')),
