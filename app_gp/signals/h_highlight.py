...
from app_gp.models import Highlight
...
def highlight_pre_save_receiver(sender, instance, *args, **kwargs):
...
pre_save.connect(highlight_pre_save_receiver, sender=Highlight, dispatch_uid='highlight_pre_save')


def highlight_post_delete_receiver(sender, instance, **kwargs):
    # Delete Image photo
    if instance.photo:
        instance.photo.delete(save=False)


post_delete.connect(highlight_post_delete_receiver, sender=Highlight, dispatch_uid='highlight_post_delete')
